...
func (s *Server) Pprof(req *proto.PprofRequest, stream proto.Metra_PprofServer) error {
	var payload []byte
...
func (s *Server) ChainWatch(req *proto.ChainWatchRequest, reply proto.Metra_ChainWatchServer) error {
