...
var file_command_server_proto_server_proto_depIdxs = []int32{
	...
	17, // 13: proto.Metra.Pprof:input_type -> proto.PprofRequest
	4,  // 14: proto.Metra.PeersAdd:input_type -> proto.PeersAddRequest
	6,  // 15: proto.Metra.PeersRemove:input_type -> proto.PeersRemoveRequest
	8,  // 16: proto.Metra.PeersList:input_type -> proto.PeersListRequest
	10, // 17: proto.Metra.PeersStatus:input_type -> proto.PeersStatusRequest
	13, // 18: proto.Metra.ChainSetHead:input_type -> proto.ChainSetHeadRequest
	24, // 19: proto.Metra.Status:input_type -> google.protobuf.Empty
	1,  // 20: proto.Metra.ChainWatch:input_type -> proto.ChainWatchRequest
	18, // 21: proto.Metra.Pprof:output_type -> proto.PprofResponse
	5,  // 22: proto.Metra.PeersAdd:output_type -> proto.PeersAddResponse
	7,  // 23: proto.Metra.PeersRemove:output_type -> proto.PeersRemoveResponse
	9,  // 24: proto.Metra.PeersList:output_type -> proto.PeersListResponse
	11, // 25: proto.Metra.PeersStatus:output_type -> proto.PeersStatusResponse
	14, // 26: proto.Metra.ChainSetHead:output_type -> proto.ChainSetHeadResponse
	15, // 27: proto.Metra.Status:output_type -> proto.StatusResponse
	2,  // 28: proto.Metra.ChainWatch:output_type -> proto.ChainWatchResponse
