...
const (
	clientIdentifier     = "metra" // Client identifier to advertise over the network
	repositoryIdentifier = "go-metra"
)
...
func prepare(ctx *cli.Context) {
	...
	case ctx.GlobalIsSet(utils.MumbaiFlag.Name):
		log.Info("Starting Metra on Mumbai testnet...")

	case ctx.GlobalIsSet(utils.MetraMainnetFlag.Name):
		log.Info("Starting Metra on Metra mainnet...")
